...
final class LuckyNumberController extends AbstractController
{
    ...
    public function show(int $id, LuckyNumberRepository $luckyNumberRepository, LuckyNumber $luckyNumber): Response
    {
        $luckyNumber = $luckyNumberRepository->findOneBy(['id' => $id]);
